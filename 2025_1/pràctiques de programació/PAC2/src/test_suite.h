...
// Tests associated to an exercise
typedef struct _tExercise {
    // Name or code of the exercise
    char* code;
    // Mark (grade) associated to the exercise. It is suppossed to be a value on range [0, 100]
    unsigned short mark;
    // Number of tests associated to the exercise
    int numTests;
    // Array of tests
    tTest* tests;
} tExercise;

// Grup of tests, used to group tests of a PR
typedef struct {
    ...
    // Number of exercises
    int numExercises;
    // Array of exercises. Tests are associated to an exercise
    tExercise* exercises;
    // Progress file
    char* progress_file;
} tTestSection;
