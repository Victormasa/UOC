...
void job_parse(tJob* data, char *companyCif, tCSVEntry entry) {
	...
	// PR2_3d
	/////////////////////////////////
  applicationQueue_createQueue(&(data->applicationsQueue));
	/////////////////////////////////
}
...
void job_cpy(tJob* destination, tJob source) {
	...
	// PR2_3d
	/////////////////////////////////
	applicationQueue_createQueue(&(destination->applicationsQueue));
	/////////////////////////////////
}
...
void job_free(tJob *data) {
	...
	// PR2_3d
	/////////////////////////////////
	applicationQueue_dequeue(&(data->applicationsQueue));
	/////////////////////////////////
}
